import scopeimg from "../assets/report/scopeimage.svg";
    ...
    <div className="reportmaincont__header">
      <div className="reportmaincont__scopecont">
        <img
          ...
          alt="scopeimg"
        />
        <p className="reportmaincont__scopename">Scope 1</p>
      </div>
      <div className="reportmaincont__genratedby">
        <div className="reportmaincont__genratedhead">
          ...
          <img
            ...
            src="./assets/report/genratedlowsoot.svg"
            alt=""
          />
        </div>
        <p className="reportmaincont__genratedmessage">
          This report consists of data about SCOPE1 emissions of a company
          defined according to UNCC standards. For any queries contact through
          below details.
        </p>
